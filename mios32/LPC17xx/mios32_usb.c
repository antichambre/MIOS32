// $Id: mios32_usb.c 1800 2013-06-02 22:09:03Z tk $
//! \defgroup MIOS32_USB
//!
...
#ifndef MIOS32_DONT_USE_USB_MIDI
  USBHwRegisterEPIntHandler(MIOS32_USB_MIDI_DATA_IN_EP, MIOS32_USB_MIDI_EP1_IN_Callback);
  USBHwRegisterEPIntHandler(MIOS32_USB_MIDI_DATA_OUT_EP, MIOS32_USB_MIDI_EP2_OUT_Callback);
#endif
...
#ifndef MIOS32_DONT_USE_USB_MIDI
    MIOS32_USB_MIDI_ChangeConnectionState(0, 0); // disconnected
#endif
#ifdef MIOS32_USE_USB_COM
...
static BOOL HandleCustomRequest(TSetupPacket *pSetup, int *piLen, U8 **ppbData)
{
  ...
  if( pSetup->bRequest == REQ_SET_CONFIGURATION ) {
    ...
    MIOS32_USB_MIDI_ChangeConnectionState(0, 1); // connected
#endif
#ifdef MIOS32_USE_USB_COM
