...
#define MIOS32_UART0             UART4
#define MIOS32_UART0_IRQ_CHANNEL UART4_IRQn
#define MIOS32_UART0_IRQHANDLER_FUNC void UART4_IRQHandler(void)
#define MIOS32_UART0_REMAP_FUNC  { GPIO_PinAFConfig(GPIOC, GPIO_PinSource10, GPIO_AF_UART4); GPIO_PinAFConfig(GPIOC, GPIO_PinSource11, GPIO_AF_UART4); }
...
#define MIOS32_UART1_REMAP_FUNC  { GPIO_PinAFConfig(GPIOA, GPIO_PinSource2, GPIO_AF_USART2); GPIO_PinAFConfig(GPIOA, GPIO_PinSource3, GPIO_AF_USART2); }
