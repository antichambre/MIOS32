...
#define J15_MODE 1	//Serial only

#define J15_SER_PORT       GPIOD        // used as DC (data/command select) for serial interfaces
#define J15_SER_PIN        GPIO_Pin_2

#define J15_E1_PORT        GPIOC        // used to control SCLK of serial interfaces
#define J15_E1_PIN         GPIO_Pin_1

#define J15_RW_PORT        GPIOC        // used to control data output of serial interfaces
#define J15_RW_PIN         GPIO_Pin_12

#define J15_CS1_PORT        GPIOB        // used to control SCLK of serial interfaces
#define J15_CS1_PIN         GPIO_Pin_12

#define J15_CS2_PORT        GPIOC
#define J15_CS2_PIN         GPIO_Pin_0
...
#define J15_PIN_CS1(b)   MIOS32_SYS_STM_PINSET(J15_CS1_PORT, J15_CS1_PIN, b)
#define J15_PIN_CS2(b)   MIOS32_SYS_STM_PINSET(J15_CS2_PORT, J15_CS2_PIN, b)

#define J15_PIN_SERLCD_DATAOUT(b) MIOS32_SYS_STM_PINSET(J15_RW_PORT, J15_RW_PIN, b)
#define J15_PIN_SERLCD_SCLK_0     { MIOS32_SYS_STM_PINSET_0(J15_E1_PORT, J15_E1_PIN); }
#define J15_PIN_SERLCD_SCLK_1     { MIOS32_SYS_STM_PINSET_1(J15_E1_PORT, J15_E1_PIN); }

#else
#define J15_MODE 0	//Not available
